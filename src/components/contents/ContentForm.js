...
import { postAddContent, fetchContent, postEditContent, postDeleteContent } from '../../actions/admin'
...
const ContentForm = props => {
   ...
   const history = useHistory()
    ...
    if(props.list.response.docs.length == 1)
    {
        ...
        definedfullName = props.list.response.docs[0].fullName
        defineduserName = props.list.response.docs[0].userName
    ...
    function onSubmit(fields) {
        ...
        if (isAddMode) {
            ...
            props.postAddContent(fields)

        } else {

            props.postEditContent(fields)
        }
    ...
    function onDeleteContent(id){
        console.log('id---',id);
        props.postDeleteContent({userId:id})
        setTimeout( ()=>{
              ...
              <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit }>
                ...
                return (
                    <Form>
                        ...
                        <FormGroup row>
                        <Label for="userName" md={3}>Content Name</Label>
                        <Col md={9}>
              ...
              <Formik initialValues={initialValues}>
                ...
                return (
                    <Form>
                        ...
                        <h1>{isAddMode ? 'Add Content' : 'View Content'}</h1>
                                ...
                                <div className="modal-content">
                                    ...
                                    <div className="modal-footer">
                                                ...
                                                <Link to={'/content/courseDetail'} className="btn btn-link">
                                                    ...
                                                    <button type="submit" className="btn btn-primary" onClick = { () => { onDeleteContent(id) } }
                                                >Delete</button>
...
export default connect(mapStateToProps, { postAddContent, postEditContent, postDeleteContent, fetchContent })(ContentForm)
