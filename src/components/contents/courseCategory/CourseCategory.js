    ...
    return ( 
                <Fragment>
                    <tr >
                        ...
                        <td>
                                <Link to= {{ pathname: `/content/courseCategory/view/${props._id}` }}  >
                                ...
                                <Link to= {{ pathname: `/content/courseCategory/edit/${props._id}` }}  >
                                ...
                                <Link to= {{ pathname: `/content/courseCategory/delete/${props._id}` }}  >
